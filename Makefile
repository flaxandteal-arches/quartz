...
ARCHES_BASE = ghcr.io/flaxandteal/arches-base:v8.2.0a2-v2
...
post-create-setup:
	...
	@if [ -f "$(ARCHES_PROJECT_ROOT).github/workflows/main.yml" ]; then \
		sed -i.bak 's|ghcr.io/flaxandteal/arches-base:v8.2.0a2-v2|$(ARCHES_BASE)|g' $(ARCHES_PROJECT_ROOT).github/workflows/main.yml && \
