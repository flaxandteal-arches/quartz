...
ARCHES_BASE = ghcr.io/flaxandteal/arches-base:v8.2.0a3-v1
...
post-create-setup:
	...
	@if [ -f "$(ARCHES_PROJECT_ROOT).github/workflows/main.yml" ]; then \
		sed -i.bak 's|ghcr.io/flaxandteal/arches-base:v8.2.0a3-v1|$(ARCHES_BASE)|g' $(ARCHES_PROJECT_ROOT).github/workflows/main.yml && \
