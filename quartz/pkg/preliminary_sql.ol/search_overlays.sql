...
INSERT INTO map_layers(maplayerid, name, layerdefinitions, isoverlay, icon, activated, addtomap, searchonly, sortorder)
   ...
   ]', TRUE, 'ion-location', TRUE, TRUE, TRUE, 0);
...
INSERT INTO map_layers(maplayerid, name, layerdefinitions, isoverlay, icon, activated, addtomap, searchonly, sortorder)
   ...
   ]', TRUE, 'ion-funnel', TRUE, FALSE, TRUE, 0);
