// Modification of default lifecycle filter to override the default filter state
// to "Draft (Standard)" if no lifecycle state filter is present 
// in the initial query string
