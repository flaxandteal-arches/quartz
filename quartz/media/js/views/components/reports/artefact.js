...
export default ko.components.register("artefact-report", {
    viewModel: function (params) {
        ...
        self.classificationDataConfig = {
            ...
            archaeologyStatus: "archaeology status",
            importantSourceOfInformation: "important source of information",
            permissionToInterferePreviouslyGranted: "permission to interfere previously granted",
        ...
        if (params.report.cards) {
            ...
            self.classificationCards = {
                ...
                archaeologyStatus: self.cards?.["archaeology status"],
                importantSourceOfInformation: self.cards?.["important source of information"],
                permissionToInterferePreviouslyGranted: self.cards?.["permission to interfere previously granted"],
                deactivationReason: self.cards?.["deactivation reason"],
                inscriptions: self.cards?.["inscriptions"],
            };
        ...
        if (discoveryNode) {
            ...
            const discoveryType = self.getNodeValue(
                discoveryNode,
                "archaeological discovery type"
            );
