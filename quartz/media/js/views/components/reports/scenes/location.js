            ...
            self.observableValueSet = (...observables) => {
                for (let observable of observables) {
                    if (ko.isObservable(observable)) {
                        ...
                        for (let key of Object.keys(observable)) {
            ...
            if (!params?.compiled) {
                ...
                if (rawAddressesNode || Array.isArray(locationNode)) {
                    const addressesNode = rawAddressesNode
                        ? Array.isArray(rawAddressesNode) ? rawAddressesNode : [rawAddressesNode]
                        : locationNode.map((locationNode) => self.getRawNodeValue(locationNode, self.dataConfig.addresses));
